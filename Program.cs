...
{
    options.Conventions.AuthorizeFolder("/MakeupArtists");
    options.Conventions.AllowAnonymousToPage("/MakeupArtists/Index");
    options.Conventions.AllowAnonymousToPage("/MakeupArtists/Details");
});
